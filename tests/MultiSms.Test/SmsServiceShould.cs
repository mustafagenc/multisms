...
public class SmsServiceShould {
  ...
  public SmsServiceShould() {
    ...
    provider1_mock.Setup(e => e.Send(It.IsAny<MessageBody>()))
        .Returns(SendingResult.Success(_provider_name_1));
    ...
    provider2_mock.Setup(e => e.Send(It.IsAny<MessageBody>()))
        .Returns(SendingResult.Success(_provider_name_2));
