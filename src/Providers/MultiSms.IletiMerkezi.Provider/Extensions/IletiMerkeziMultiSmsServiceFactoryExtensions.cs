...
public static class IletiMerkeziMultiSmsServiceFactoryExtensions {
  ...
  UseIletiMerkezi(this MultiSmsServiceFactory builder, string username,
                  string password, string orginator) {
  ...
  public static MultiSmsServiceFactory
  UseIletiMerkezi(this MultiSmsServiceFactory builder,
