...
public sealed partial class PhoneNumber : IEquatable<PhoneNumber>,
  ...
  public bool Equals(PhoneNumber other) {
    return other is not null &&
           other.ToString().Equals(_phoneNumber,
  ...
  public bool Equals(string other) {
    return other is not null &&
           other.Equals(_phoneNumber, StringComparison.OrdinalIgnoreCase);
  }

  public override int GetHashCode() { return HashCode.Combine(_phoneNumber); }
  ...
  operator PhoneNumber(string phoneNumber) => new(phoneNumber);
  ...
  public static bool operator !=(PhoneNumber left,
                                 PhoneNumber right) => !(left == right);
