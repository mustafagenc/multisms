...
public partial class TwilioProvider
{
    ...
    {
        var attemptChannelData = message.ProviderData.GetData(CustomProviderData.Attempt);
        var mediaUrlChannelData = message.ProviderData.GetData(CustomProviderData.MediaUrl);
        var maxPriceChannelData = message.ProviderData.GetData(CustomProviderData.MaxPrice);
        var sendAsMmsChannelData = message.ProviderData.GetData(CustomProviderData.SendAsMms);
        var smartEncodedChannelData = message.ProviderData.GetData(CustomProviderData.SmartEncoded);
        var forceDeliveryChannelData = message.ProviderData.GetData(CustomProviderData.ForceDelivery);
        var applicationSidChannelData = message.ProviderData.GetData(CustomProviderData.ApplicationSid);
        var statusCallbackChannelData = message.ProviderData.GetData(CustomProviderData.StatusCallback);
        var pathAccountSidChannelData = message.ProviderData.GetData(CustomProviderData.PathAccountSid);
        var validityPeriodChannelData = message.ProviderData.GetData(CustomProviderData.ValidityPeriod);
        var provideFeedbackChannelData = message.ProviderData.GetData(CustomProviderData.ProvideFeedback);
        var persistentActionChannelData = message.ProviderData.GetData(CustomProviderData.PersistentAction);
        var messagingServiceSidChannelData = message.ProviderData.GetData(CustomProviderData.MessagingServiceSid);
