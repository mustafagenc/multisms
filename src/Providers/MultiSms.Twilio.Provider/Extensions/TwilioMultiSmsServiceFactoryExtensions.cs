...
public static class TwilioMultiSmsServiceFactoryExtensions {
  ...
  public static MultiSmsServiceFactory
  UseTwilio(this MultiSmsServiceFactory builder, string username,
            string password) => builder.UseTwilio(username, password, null);

  public static MultiSmsServiceFactory
  UseTwilio(this MultiSmsServiceFactory builder, string username,
            string password, string accountSID) => builder.UseTwilio(op => {
  ...
  public static MultiSmsServiceFactory
  UseTwilio(this MultiSmsServiceFactory builder,
