...
public readonly struct ProviderData : IEquatable<ProviderData> {
  ...
  public override int GetHashCode() { return HashCode.Combine(Key); }

  public static bool operator ==(ProviderData left, ProviderData right) =>
      EqualityComparer<ProviderData>.Default.Equals(left, right);
