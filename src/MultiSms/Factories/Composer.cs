...
public class Composer
{
    ...
    public Composer To(string phoneNumber) => To(new PhoneNumber(phoneNumber.Trim()));
    ...
    public Composer PassProviderData(string key, object value) => PassProviderData(new ProviderData(key, value));
